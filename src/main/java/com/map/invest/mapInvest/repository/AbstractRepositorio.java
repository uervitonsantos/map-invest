...
import com.map.invest.mapInvest.entity.MapInvestEntity;
import com.map.invest.mapInvest.filtro.*;
import com.map.invest.mapInvest.util.constantes.TipoOrdenacaoEnum;
...
public abstract class AbstractRepositorio {
    ...
    public void refresh(com.map.invest.mapInvest.entity.MapInvestEntity entidade) {
