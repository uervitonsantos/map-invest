...
public interface PessoaController extends Resource {
    ...
    @Operation(summary = "Retorna o usuário consultada pelo codigo identificador (id)", description = "Retorna um usuário cadastrado", responses = {
            @ApiResponse(responseCode = Resource.RESPONSE_OK, description = "Sucesso", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(description = "Objeto Json retornado na busca do usuário", implementation = PessoaDTO.class))),
            @ApiResponse(responseCode = Resource.RESPONSE_BAD_REQUEST, description = "Código do usuário invalido", content = @Content),
    ...
    @Operation(summary = "Retorna lista de usuários", description = "Retorna uma lista de todos os usuários cadastrados", responses = {
            @ApiResponse(responseCode = Resource.RESPONSE_OK, description = "Sucesso", content = @Content(mediaType = MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(description = "Objeto Json retornado na busca do usuário", implementation = PessoaDTO.class)))),
            @ApiResponse(responseCode = Resource.RESPONSE_UNAUTHORIZED, description = "Usuário não autorizado", content = @Content),
            @ApiResponse(responseCode = Resource.RESPONSE_FORBIDDEN, description = "Usuário não autorizado", content = @Content)})
    ...
    @Operation(summary = "Cria um novo usuário", description = "Cria um novo usuário e adiciona a lista de usuários cadastrados",
            requestBody = @RequestBody(description = "Dados necessarios para a  criação de um novo usuário", required = true,
                    content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = Resource.REF_USUARIO_POST_REQUEST))),
            responses = {
                    @ApiResponse(responseCode = Resource.RESPONSE_OK, description = "Sucesso.", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(description = "Objeto Json retornado na criação do usuário", implementation = PessoaDTO.class))),
    ...
    @Operation(summary = "Atualiza um usuário", description = "Atualiza um usuário cadastrado",
            requestBody = @RequestBody(description = "Dados necessarios para a  atualização de um usuário", required = true,
                    content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = Resource.REF_USUARIO_PUT_REQUEST))),
            responses = {
                    @ApiResponse(responseCode = Resource.RESPONSE_OK, description = "Sucesso", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(description = "Objeto Json retornado na atualização do usuário", implementation = PessoaDTO.class))),
